...
class DriftMerchantsDao extends DatabaseAccessor<Mp3Database>
    with _$DriftMerchantsDaoMixin
    implements MerchantsDao {
  DriftMerchantsDao(Mp3Database db) : super(db);
  ...
  Merchant _toModel({
    ...
    return Merchant(
      ...
      locales: merchantLocaleDto.map((dto) => dto.locale).toList(),
